package com.sritest.myapp.web.rest;
...
import com.sritest.myapp.config.KafkaProperties;
...
class SamplemicroangularkafkaappKafkaResourceIT {
    ...
    void setup() {
        ...
        SamplemicroangularkafkaappKafkaResource kafkaResource = new SamplemicroangularkafkaappKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/samplemicroangularkafkaapp-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/samplemicroangularkafkaapp-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
