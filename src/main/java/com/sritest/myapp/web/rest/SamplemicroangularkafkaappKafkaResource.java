...
@RestController
@RequestMapping("/api/samplemicroangularkafkaapp-kafka")
public class SamplemicroangularkafkaappKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SamplemicroangularkafkaappKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SamplemicroangularkafkaappKafkaResource(KafkaProperties kafkaProperties) {
